(function () {
    ...
    myCSS += '#my_unique_id {z-index:10000;position:fixed;top:0;right:450px;background-color:#fff;}';
    myCSS += '#my_unique_id .c {width: 400px;padding:20px; background-color: red}';
