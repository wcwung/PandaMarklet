(function () {
    ...
    myCSS += '#my_unique_id, #my_unique_id *{font-family:"Roboto","Courier New",sans-serif;color:#fff;line-height:1.5em;font-size:15px;margin:0;padding:0;text-shadow:none;}';
