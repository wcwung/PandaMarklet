...
var showBookMarklet = function() {
    ...
    myCSS += '#my_unique_id, #my_unique_id *{font-family:"Roboto","Courier New",sans-serif;color:#fff;line-height:0;font-size:15px;padding:0;text-shadow:none;}';
    ...
    myHTML += '<br><input type="checkbox" value="None" id="papplied" name="check" /><label for="papplied">Applied?</label></div>';
    myHTML += '<br><input type="checkbox" value="None" id="pfavorite" name="check" /><label for="pfavorite">Favorite?</label></div>';
